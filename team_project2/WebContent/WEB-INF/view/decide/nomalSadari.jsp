...
var Yl = {
 ...
 ,init : function(){
  ...
  var foodList = this.getEl("sel_num").value;
...
<div id="div_step2" style="font-size:20px;display:none; margin-bottom:30px;" align="center">
<input type="text" value="text" readonly="readonly" style="width:50px;height:20px; font-size: 23px; "/>
 입력후 게임 시작 <input type="button" value="시작" onclick="Yl.create();" style="width:50px;height:25px;"/>
</div>

<div id="div_body" style="width:1000px;height:450px;border:1px solid #CCCCCC;position:relative;">
	<div id="div_step1" align="center" style="font-size:20px; margin-top:150px">
	
	<h1>사다리의 갯수를 정해주세요!</h1>
	
	<select id="sel_num" style="width:100px; height:26px; margin-right:20px; font-size: 20px;" >
	...
	<input type="button" value="만들기" onclick="Yl.init();" style="margin-left:20px; width:50px;height:26px; margin-right:50px;"/>
	</div>
</div>
